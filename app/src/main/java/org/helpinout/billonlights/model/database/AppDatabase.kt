...
import org.helpinout.billonlights.model.database.dao.NotificationDao
...
@Database(entities = [(Registration::class), (AddCategoryDbItem::class), (MappingDetail::class), (NotificationItem::class)], version = 5, exportSchema = false)
