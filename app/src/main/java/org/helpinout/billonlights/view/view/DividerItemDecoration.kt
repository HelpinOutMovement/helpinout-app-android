...
class DividerItemDecoration : androidx.recyclerview.widget.RecyclerView.ItemDecoration {
    ...
    override fun getItemOffsets(outRect: Rect, view: View, parent: androidx.recyclerview.widget.RecyclerView, state: androidx.recyclerview.widget.RecyclerView.State) {
        ...
        orientation = (parent.layoutManager as androidx.recyclerview.widget.LinearLayoutManager).orientation
        if (orientation == androidx.recyclerview.widget.LinearLayoutManager.HORIZONTAL) {
     ...
     * added
     */
    private fun drawHorizontalDividers(canvas: Canvas, parent: androidx.recyclerview.widget.RecyclerView) {
     ...
     * added
     */
    private fun drawVerticalDividers(canvas: Canvas, parent: androidx.recyclerview.widget.RecyclerView) {
