    ...
    fun getReceivedOffers(offerType: Int): MutableLiveData<List<OfferReceived>> {
        ...
        if (offerType == OFFER_RECEIVED) {
            offerItemList.add(
                OfferReceived(
                    "Tina Jamna",
                    "has offered to help you. 14 April 2020, 10:45 am Call them on +91 543053490 Time: 6pm to 9pm.",
                    "+91 543053490",
                    R.drawable.ic_food
                )
            )
            ...
            offerItemList.add(
                OfferReceived(
                    "Anupam Gupta",
                    "has requested your help 14 April 2020, 10:45 am Call them on +91 543053490",
                    "+91 543053490",
                    R.drawable.ic_food
                )
            )
    ...
    fun getRequestSent(offerType: Int): MutableLiveData<List<RequestSent>> {
        ...
        if (offerType == REQUEST_SENT) {
            offerItemList.add(
                RequestSent(
                    "Tina Jamna",
                    "was sent a help request on 14 April 2020, 10:45 am They will call you if they can help you.",
                    R.drawable.ic_food
                )
            )
            offerItemList.add(
            ...
            offerItemList.add(
                RequestSent(
                    "Tina Jamna",
                    "was sent your offer to help on 14 April 2020, 10:45 am. They will call you if they need your help",
                    R.drawable.ic_food
                )
            )
            offerItemList.add(
